...
1. **Separate versioned state.** Persist a closed builder draft schema independent
   of the generated persona pack schema. Unknown versions/fields fail closed and
   use explicit, copy-on-write migration.
