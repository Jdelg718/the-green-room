...
- Protected-main base: `adf129896814ebc3a45980833a059660096c7f56`, tree `eb7b0a39438976a3171e920d877260c9e79c0e1e`.
...
- The source/policy freeze creates no archive or IPA, performs no signing or device action, changes no App Store Connect state, and sends no invitation.
...
3. A human operator performs the Apple Distribution archive/export outside this source-only task, audits the exact IPA, and records its checksum.
