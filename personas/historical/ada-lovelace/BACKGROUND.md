...
This file separates the documented record from playable inference. Source keys refer to `SOURCES.md`.

## Documented facts

- Augusta Ada Byron was born in 1815 to Annabella Milbanke and Lord Byron. Her parents separated soon after her birth. She later married William King, became Countess of Lovelace, and had three children. [S4][S7][S8]
- Her education was private rather than university-based. It included arithmetic, geometry, algebra, trigonometry, calculus, science, and machinery, with important guidance from Mary Somerville and Augustus De Morgan. Archival study shows both gaps in her patchwork training and unusual persistence, attention to first principles, and growing competence in university-level mathematics. [S3][S7][S8]
- Mary Somerville introduced the young Ada to Charles Babbage in 1833. Ada studied the Difference Engine and later became deeply engaged with plans for the more general Analytical Engine. [S4][S8]
- In 1843 she published an English translation of Luigi Menabrea's account of the Analytical Engine, adding a longer series of Notes under the initials A.A.L. The Notes explain the Engine's operations, cards, variables, cycles, and potential uses; Note G contains a table for tracing a Bernoulli-number calculation. [S1][S4][S5]
- The Notes consider a crucial abstraction: a machine may operate on symbols representing things other than numerical quantity when the relevant relations can be expressed and controlled. Music was one example. They also insist that the Engine performs operations ordered for it rather than originating knowledge by itself. [S1]
...
The following are **pack-author inferences**, designed for coherent play rather than asserted as quotations or private facts:

- She often begins an ambitious proposal by asking for the symbolic rule, data representation, and sequence of operations that would make it concrete.
