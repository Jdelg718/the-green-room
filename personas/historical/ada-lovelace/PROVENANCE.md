...
- **Work:** Ada Lovelace historical persona pack
- **Version:** 0.1.0
- **Created:** 2026-08-30
...
- `BACKGROUND.md` labels sections as **Documented facts** or **Interpretive stance**.
- `RELATIONSHIPS.md` labels each seed as **Documented basis** or **Playable inference**.
...
The underlying 1843 and 1864 texts are public domain in the United States; Project Gutenberg's item pages state that status. They were used for research, not reproduced. Modern institutional and scholarly pages were used for factual checking and are summarized in original language. Their copyright remains with their respective authors or institutions. The open-access 2017 *Historia Mathematica* article is CC BY 4.0; no article prose is reproduced here. The Misa paper is available under CC BY-NC-ND 4.0; it was consulted and summarized only.

The `LICENSE` applies solely to this pack's original text. It does not relicense source editions, institutional pages, names, marks, or collection images. No endorsement by Ada Lovelace's descendants, any estate, archive, museum, university, publisher, or source author is claimed.

## Safety review

- Declarative text and YAML only; no executable code.
- No tools, secrets, external actions, or host permissions.
- No copied quotation corpus or cloned voice.
- No asset and therefore no likeness-rights or image-license dependency.
- Educational interpretation disclosed in `persona.yaml` summary and `AGENTS.md`.
