...
- the current integrated release gate: 179 passing Node tests, 227 passing Python validator tests, TypeScript typecheck/build, Ruff formatting/lint, mypy, and private first-playable acceptance.
