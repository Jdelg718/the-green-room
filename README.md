...
No Official Catalog Manifest exists yet. The runtime strictly validates 12 historical candidate packs, including Benjamin Franklin and Nicolaus Copernicus, but validation is not catalog admission. The 12 optimized AI-generated portraits are approved for public-site presentation as clearly labeled creative historical interpretations. That site-only approval is not Official Catalog admission: the portraits remain excluded from runtime packs, installers, and catalog distribution until the exact pack versions and asset digests pass the separate catalog gate.
